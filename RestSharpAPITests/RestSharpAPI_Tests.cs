...
namespace RestSharpAPITests
{
    public class RestSharpAPI_Tests
    {
        ...
        private const string baseUrl = "https://ivankyosevcontactbook.ibk92.repl.co";
        ...
        public void FirstContactByKeywordShouldBeAlbertEinstein()
        {
            ...
            RestRequest request = new RestRequest("/contacts/search/albert");
        ...
        {
            RestRequest request = new RestRequest("/contacts/search/missing{random_number}");
